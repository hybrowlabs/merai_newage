...
#     # frappe.enqueue(
#     #     "chatnext_manufacturing.config.py.work_order_override._print_work_order",
#     #     name=name,
#     #     task_id=task_id,
#     #     queue="long",
#     # )
...
#         description=_("Preparint to generate PDF"),
#         task_id=task_id,
#     )

#     # print_pre_work_order(name, pdf_writer, task_id=task_id, default_letter_head=default_letter_head)
#     print_job_cards(
#         name, pdf_writer, task_id=task_id,default_letter_head=default_letter_head
#     )
#     # print_post_work_order(
#     #     name,
#     #     pdf_writer,
#     #     work_order_doc.custom_print_with_final_qc == 1,
#     #     task_id=task_id,default_letter_head=default_letter_head
#     # )

#     with BytesIO() as merged_pdf:
#         pdf_writer.write(merged_pdf)
#         if task_id:
#             # create file from pdfwriter
...
# def print_pre_work_order(name, pdf_writer, task_id=None, default_letter_head=None):
#     #     fetch work order doc
#     work_order_doc = frappe.get_doc("Work Order", name)

#     # print("print here!", work_order_doc.custom_print_format, work_order_doc.name)
#     if work_order_doc.custom_pre_operations_print_format:
#         pdf_writer = frappe.get_print(
#             "Work Order",
#             work_order_doc.name,
#             print_format=work_order_doc.custom_pre_operations_print_format,
#             as_pdf=True,
#             no_letterhead=0,
#             # letterhead="Suture Letter Head",
#             letterhead=default_letter_head,
#             output=pdf_writer,
...
#             percent=10,
#             title="Generating PDF",
#             description=_("Generating PDF for Pre Work Order"),
#             task_id=task_id,
#         )


# def print_post_work_order(name, pdf_writer, with_final_qc=False, task_id=None, default_letter_head=None):
#     #     fetch work order doc
#     work_order_doc = frappe.get_doc("Work Order", name)
#     # print("print here!", work_order_doc.custom_print_format, work_order_doc.name)
#     if work_order_doc.custom_post_operations_print_format:
#         pdf_writer = frappe.get_print(
#             "Work Order",
#             work_order_doc.name,
#             print_format=work_order_doc.custom_post_operations_print_format,
#             as_pdf=True,
#             no_letterhead=0,
#             letterhead=default_letter_head,
#             output=pdf_writer,
...
#             percent=90,
#             title="Generating PDF",
#             description=_("Generating PDF for Post Work Order"),
#             task_id=task_id,
#         )

#     if with_final_qc:
#         # fetch stock entry for manufacture and get quality inspection of finished goods
#         stock_entry = frappe.get_list(
#             "Stock Entry",
#             filters=[
#                 ["Stock Entry", "work_order", "=", work_order_doc.name],
#                 ["Stock Entry", "purpose", "=", "Manufacture"],
#             ],
#             pluck="name",
#         )
#         if stock_entry:
#             stock_entry = frappe.get_doc("Stock Entry", stock_entry[0])
#             items = stock_entry.items
#             for item in items:
#                 if item.item_code == work_order_doc.production_item:
#                     if item.quality_inspection:
#                         quality_inspection_doc = frappe.get_doc(
#                             "Quality Inspection", item.quality_inspection
#                         )
#                         pdf_writer = frappe.get_print(
#                             "Quality Inspection",
#                             item.quality_inspection,
#                             print_format=quality_inspection_doc.custom_print_format,
#                             as_pdf=True,
#                             no_letterhead=0,
#                             letterhead=default_letter_head,
#                             output=pdf_writer,
...
#                 percent=90,
#                 title="Generating PDF",
#                 description=_("No Stock Entry Found"),
#             ),
#         # pdf_writer = frappe.get_print(
#         #     "Quality Inspection", work_order_doc.name, print_format=work_order_doc.custom_final_qc_print_format,
#         #     as_pdf=True,
#         #     no_letterhead=0,
#         #     letterhead="Suture Letter Head",
#         #     output=pdf_writer, pdf_options={"page-size": "A4", "encoding": "UTF-8"},
#         # )


# def print_job_cards(name, pdf_writer, with_ipqc=None, task_id=None,default_letter_head=None):
...
#             if job_card_doc.company == "Meril Life Sciences Pvt. Ltd.":
#                 intimation_list = frappe.get_all("Intimation For Label Printing", filters={"job_card_reference": job_card_doc.name, "docstatus": 0}, pluck="name")
#                 if intimation_list:
...
#                 label_printing_list = frappe.get_all("Label Printing", filters={"job_card_reference": job_card_doc.name, "docstatus": 1}, pluck="name")
#                 if label_printing_list:
...
#                 bmr_for_packing_material = frappe.get_all("BMR For Packing Material", filters={"job_card_reference": job_card_doc.name, "docstatus": 1}, pluck="name")
#                 if bmr_for_packing_material:
...
#                 bio_burden_qc_doc = frappe.get_doc("Quality Inspection", job_card_doc.custom_bio_burden_qc)
#                 if bio_burden_qc_doc.custom_print_format:
#                     pdf_writer = frappe.get_print(
#                             "Quality Inspection",
#                             bio_burden_qc_doc.name,
#                             print_format=bio_burden_qc_doc.custom_print_format,
#                             as_pdf=True,
#                             output=pdf_writer,
#                             pdf_options={"page-size": "A4", "encoding": "UTF-8"},
#                         )
...
#                 "Job Card",
#                 job_card_doc.name,
#                 print_format=job_card_doc.custom_print_format,
#                 as_pdf=True,
#                 no_letterhead=0,
#                 letterhead=default_letter_head,
#                 output=pdf_writer,
...
#             # if (
#             #     with_ipqc
#             #     and job_card_doc.custom_quality_inspection_required
#             #     and job_card_doc.quality_inspection
#             # ):
#             #     print(
#             #         "with ipqc", job_card_doc.operation, job_card_doc.quality_inspection
#             #     )

#             #     ipqc_doc = frappe.get_doc(
#             #         "Quality Inspection", job_card_doc.quality_inspection
#             #     )
                
#             #     if ipqc_doc.custom_print_format:
#             #         pdf_writer = frappe.get_print(
#             #             "Quality Inspection",
#             #             ipqc_doc.name,
#             #             print_format=ipqc_doc.custom_print_format,
#             #             as_pdf=True,
#             #             output=pdf_writer,
#             #             pdf_options={"page-size": "A4", "encoding": "UTF-8"},
#             #         )
...
#             #     if job_card_doc.company == "Meril Life Sciences Pvt. Ltd.":
#             #         ipqcList = [
#             #                 job_card_doc.custom_quality_inspection_3,
#             #                 job_card_doc.custom_quality_inspection_4,
#             #                 job_card_doc.custom_quality_inspection_5,
#             #                 job_card_doc.custom_quality_inspection_6]

#             #         for qc_name in ipqcList:
#             #             if qc_name:
#             #                 qc = frappe.get_doc("Quality Inspection", qc_name)
#             #                 if qc.custom_print_format:
#             #                     pdf_writer = frappe.get_print(
#             #                         "Quality Inspection",
#             #                         qc.name,
#             #                         print_format=qc.custom_print_format,
#             #                         as_pdf=True,
#             #                         output=pdf_writer,
#             #                         pdf_options={"page-size": "A4", "encoding": "UTF-8"},
#             #                     )
...
#             # if job_card_doc.company == "Meril Life Sciences Pvt. Ltd.":
#             #     mtn_list = frappe.get_all("Material Transfer Note", filters={"job_card_reference": job_card_doc.name, "docstatus": 1}, pluck="name")
#             #     for mtn_name in mtn_list:
#             #         mtn_doc = frappe.get_doc("Material Transfer Note", mtn_name)
#             #         pdf_writer = frappe.get_print(
#             #         "Material Transfer Note",
#             #         mtn_doc.name,
#             #         print_format=mtn_doc.custom_print_format or "NAV - FG - MTN",
#             #         as_pdf=True,
#             #         output=pdf_writer,
#             #         pdf_options={"page-size": "A4", "encoding": "UTF-8"},
#             #         )
