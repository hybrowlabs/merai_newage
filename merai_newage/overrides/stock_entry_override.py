...
def get_operating_cost_per_unit(work_order=None, bom_no=None):
	"""
	Get operating cost per unit from Work Order or BOM.

	Args:
		work_order (str, optional): Work Order name. Defaults to None.
		bom_no (str, optional): BOM name. Defaults to None.

	Returns:
		float: Operating cost per unit.
	"""
