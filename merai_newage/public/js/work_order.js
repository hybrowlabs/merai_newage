        ...
        frappe.db.get_single_value(
            ...
            setTimeout(function () {
                ...
                frm.page.btn_secondary
                    .find('.btn[data-original-title="Print"]')
                    .hide();
                $('.icon-btn svg use[href="#icon-printer"]')
                    .closest('.btn')
                    .hide();
            }, 100);
            ...
            if (frm.doc.status === "Completed") {
                frm.add_custom_button("Print DHR", function () {
                    frappe.call({
                        ...
                        callback: function (response) {
                            window.open(
                                window.location.origin + response.filecontent
                            );
                        }
                    });
                });
                    ...
                    frm.add_custom_button(
                        ...
                        async function () {
                            try {
                                ...
                                frappe.msgprint(
                                    __("Something went wrong: ") + e.message
                                );
                            }
                        }
                    );
