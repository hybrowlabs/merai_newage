...
//             // ===Create Asset ERPNEXT from CWIP PRs===
...
//                 <td><a href="/app/purchase-receipt/${row.purchase_receipt}" target="_blank">${row.purchase_receipt}</a></td>
//                 <td>
//                     <button class="btn btn-xs btn-default" 
//                             onclick="frappe.set_route('Form', 'Asset', '${row.asset}')">
//                         View
//                     </button>
//                 </td>
//             </tr>
...
//         <h5 style="margin-top: 20px;">Detailed List</h5>
...
//     prs.forEach(pr => {
//         let type = pr.is_service_item ? 
//             '<span class="badge badge-info">Service</span>' : 
//             '<span class="badge badge-primary">Stock/Asset</span>';
            
//         html += `
//             <tr>
//                 <td><a href="/app/purchase-receipt/${pr.purchase_receipt}" target="_blank">${pr.purchase_receipt}</a></td>
//                 <td>${pr.pr_date || ''}</td>
